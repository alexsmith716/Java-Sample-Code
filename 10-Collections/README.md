...
1. Navigate into directory `10-Collections`
...
1. Navigate into directory `10-Collections`
2. Enter command: `java -classpath bin examples/CollectionExample`


### Output

```
% java -classpath bin examples/CollectionExample
Value at index 2: World
[Hello,  , World, !]
```
